...

  {
    ...
    cateItems: [
      ...
      },
      {
        ...
        url: "#",
        type: "",
        memos: ["홍길동 : 2023-11-20 디자인 검토 필요"],
      },
    ],
  },
];
...
for (let i = 0; i < ia.length; i++) {
  ...
  for (let j = 0; j < ia[i].cateItems.length; j++) {
    ia_html =
      ia_html +
      "" +
      '		<tr class="g-ia-item is-' +
      ia[i].cateItems[j].state +
      '">' +
      '			<td class="g-ia-num">' +
      (j + 1) +
      "</td>" +
